...
namespace BancoDadosTest.UnitTest
{
    public class AlunoInputValidatorTests
    {
        ...
        public void AlunoInputValidator_NomeInvalido_ShouldReturnErrorMessage(string casoTeste, string nome, int repeticaoConcat)
        {
        ...
        public void AlunoInputValidator_UsuarioInvalido_ShouldReturnErrorMessage(string casoTeste, string usuario, int repeticaoConcat)
        {
        ...
        public void AlunoInputValidator_SenhaInvalida_ShouldReturnErrorMessage(string casoTeste, string senha, int repeticaoConcat)
        {
